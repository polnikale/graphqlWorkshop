...
export type ValueSearchQueryVariables = {
  name: Scalars['String']
};


export type ValueSearchQuery = (
  { __typename?: 'Query' }
  & { missions: Maybe<Array<Maybe<(
    { __typename?: 'Mission' }
    & Pick<Mission, 'id' | 'name' | 'description' | 'twitter' | 'website'>
...
export type AllSearchComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<AllSearchQuery, AllSearchQueryVariables>, 'query'>;
    ...
    export const AllSearchComponent = (props: AllSearchComponentProps) => (
      <ApolloReactComponents.Query<AllSearchQuery, AllSearchQueryVariables> query={AllSearchDocument} {...props} />
    );
    
export type AllSearchProps<TChildProps = {}> = ApolloReactHoc.DataProps<AllSearchQuery, AllSearchQueryVariables> & TChildProps;
export function withAllSearch<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  AllSearchQuery,
  AllSearchQueryVariables,
  AllSearchProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, AllSearchQuery, AllSearchQueryVariables, AllSearchProps<TChildProps>>(AllSearchDocument, {
      alias: 'allSearch',
      ...operationOptions
    });
};
...
/**
 * __useAllSearchQuery__
 *
 * To run a query within a React component, call `useAllSearchQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllSearchQuery` returns an object from Apollo Client that contains loading, error, and data properties 
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllSearchQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllSearchQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<AllSearchQuery, AllSearchQueryVariables>) {
        return ApolloReactHooks.useQuery<AllSearchQuery, AllSearchQueryVariables>(AllSearchDocument, baseOptions);
      }
export function useAllSearchLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<AllSearchQuery, AllSearchQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<AllSearchQuery, AllSearchQueryVariables>(AllSearchDocument, baseOptions);
        }
export type AllSearchQueryHookResult = ReturnType<typeof useAllSearchQuery>;
export type AllSearchLazyQueryHookResult = ReturnType<typeof useAllSearchLazyQuery>;
export type AllSearchQueryResult = ApolloReactCommon.QueryResult<AllSearchQuery, AllSearchQueryVariables>;
export const ValueSearchDocument = gql`
  ...
  missions(limit: 10, find: {name: $name}) {
    ...
    `;
export type ValueSearchComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<ValueSearchQuery, ValueSearchQueryVariables>, 'query'> & ({ variables: ValueSearchQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const ValueSearchComponent = (props: ValueSearchComponentProps) => (
      <ApolloReactComponents.Query<ValueSearchQuery, ValueSearchQueryVariables> query={ValueSearchDocument} {...props} />
    );
    
export type ValueSearchProps<TChildProps = {}> = ApolloReactHoc.DataProps<ValueSearchQuery, ValueSearchQueryVariables> & TChildProps;
export function withValueSearch<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  ValueSearchQuery,
  ValueSearchQueryVariables,
  ValueSearchProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, ValueSearchQuery, ValueSearchQueryVariables, ValueSearchProps<TChildProps>>(ValueSearchDocument, {
      alias: 'valueSearch',
      ...operationOptions
    });
};
...
/**
 * __useValueSearchQuery__
 *
 * To run a query within a React component, call `useValueSearchQuery` and pass it any options that fit your needs.
 * When your component renders, `useValueSearchQuery` returns an object from Apollo Client that contains loading, error, and data properties 
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useValueSearchQuery({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useValueSearchQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ValueSearchQuery, ValueSearchQueryVariables>) {
        return ApolloReactHooks.useQuery<ValueSearchQuery, ValueSearchQueryVariables>(ValueSearchDocument, baseOptions);
      }
export function useValueSearchLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ValueSearchQuery, ValueSearchQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ValueSearchQuery, ValueSearchQueryVariables>(ValueSearchDocument, baseOptions);
        }
